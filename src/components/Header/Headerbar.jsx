      ...
      <Row className="align-items-center py-2">
        ...
        <Col md={2} xs={4}>
          <Row className="d-flex justify-content-center">
            <Col xs={4}>
              <Link to="/groups">
                <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-people-fill" width="30" height="30" fill="currentColor"  viewBox="0 0 640 512">
            ...
            <Col xs={4}>
              <Link to="/">
                <svg xmlns="http://www.w3.org/2000/svg" className="bi-bar-chart-fill" width="30" height="30" fill="currentColor" viewBox="0 0 640 512"><path d="M192 64C86 64 0 150 0 256S86 448 192 448l256 0c106 0 192-86 192-192s-86-192-192-192L192 64zM496 168a40 40 0 1 1 0 80 40 40 0 1 1 0-80zM392 304a40 40 0 1 1 80 0 40 40 0 1 1 -80 0zM168 200c0-13.3 10.7-24 24-24s24 10.7 24 24l0 32 32 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-32 0 0 32c0 13.3-10.7 24-24 24s-24-10.7-24-24l0-32-32 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l32 0 0-32z"/></svg>
              </Link>
            </Col>
            <Col xs={4}>
              <Link onClick={handleClick}>
                <div ref={ref}>
                <svg xmlns="http://www.w3.org/2000/svg" className=" bi bi-bar-chart-fill" width="20" height="20" fill="currentColor" viewBox="0 0 448 512"><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512l388.6 0c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304l-91.4 0z"/></svg> 
                </div>
              </Link>
            </Col>
          </Row>
