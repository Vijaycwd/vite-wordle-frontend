...
function Registerform() {
    ...
    const signUp = async (e) => {
        ...
        try {
            const userRes = await Axios.post('http://localhost:5001/use/create-user', userObject, HEADERS);
            ...
            if (userRes.data.message) {
                ...
                try {
                    const statsRes = await Axios.post('http://localhost:5001/wordle-game-stats/create-stats', TotalGameObject);
                    if (statsRes.data) {
